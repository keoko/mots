...
export const topics = [
  {
    ...
    words: [
      ...
      { ca: 'pols facial', en: 'face powder' },
      { ca: 'llet de neteja', en: 'cleansing milk' },
      { ca: 'crema bronzejadora', en: 'suntan lotion' },
      { ca: 'protecció solar', en: 'sun protection' },
      { ca: 'crema per taló esquerdat', en: 'cracked heel cream' }
    ]
  },
  {
    id: 'infancy',
    ...
    words: [
      ...
      { ca: 'gatejar', en: 'crawling' },
      { ca: 'polls', en: 'lice' },
      { ca: 'llémena', en: 'nit' },
      { ca: 'oli de rosa mosqueta', en: 'wild rose oil' },
      { ca: 'conjuntivitis', en: 'conjunctivitis' },
      { ca: 'tovalloletes humides', en: 'baby wipes' },
      { ca: 'pols de talc', en: 'talcum powder' },
      { ca: 'xumet', en: 'pacifier/dummy' },
      { ca: 'menjar per a nadons', en: 'baby food' },
      { ca: 'biberó', en: 'baby\'s bottle/feeding bottle' },
      { ca: 'loció/xampú antipiolls', en: 'anti-lice lotion/shampoo' },
  ...
  },
  {
    ...
    words: [
      ...
      { ca: 'compresas', en: 'sanitary towels' },
  ...
  },
  {
    ...
    words: [
      ...
      { ca: 'pedra tosca', en: 'pumice stone' },
